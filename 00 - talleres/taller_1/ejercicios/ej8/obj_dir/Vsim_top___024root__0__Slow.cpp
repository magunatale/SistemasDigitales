...
#endif
            VL_FATAL_MT("/workspaces/sistemas-digitalles-taller-1/ejercicios/lib/sim_top.sv", 5, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__resta__DOT__b2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7480095234684022495ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__resta__DOT__b3 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2792257003967954512ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__resta__DOT__restaUno__DOT__b1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13139520627949527222ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__suma__DOT__c2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11602062076110456913ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__suma__DOT__c3 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15702951283771575159ull);
